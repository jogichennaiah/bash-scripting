...
aws ec2 run-instances --image-id ami-0c1d144c8fdd8d690 --count 1 --instance-type t3.micro  --security-group-ids sg-0c848594407d0f2a8 --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=lab}]" 
