...
sed -i -e 's/REDIS_ENDPOINT/redis.roboshop.in/' /home/${APPUSER}/${COMPONENT}/systemd.service -e 's/MONGO_ENDPOINT/mongodb.roboshop.in/' /home/${APPUSER}/${COMPONENT}/systemd.service
